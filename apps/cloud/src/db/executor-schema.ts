...
export const connection = pgTable(
  "connection",
  {
    ...
    tools_sync_started_at: bigint("tools_sync_started_at", { mode: "bigint" }),
    ...
    refresh_lease_until: bigint("refresh_lease_until", { mode: "bigint" }),
    refresh_lease_holder: text("refresh_lease_holder"),
    oauth_refreshed_at: bigint("oauth_refreshed_at", { mode: "bigint" }),
